       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-light rounded">
        ...
        <div class="row">
            <div class="col-lg-12 mb-12">
                ...
                <li><a href="mapa_procesos/mapa/direccionamientoyplaneacion/formatos/Formato para caracterizacion de usuarios V1.xlsx" rel="nofollow">Caracterización de usuarios V1</a></li>
                ...
                <br><br>
                <hr>
                <a href="procesos_mipg.php" rel="nofollow"><img class="mb-2" src="img/MIPG.png" alt="" width="10%"> <h3>Modelo integrado de planeación y gestión - MIPG</h3></a>
